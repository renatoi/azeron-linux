...
echo ""
echo "After installing the built app, grant Input Monitoring access:"
echo "  System Settings -> Privacy & Security -> Input Monitoring -> '+' -> azeron-software"
echo ""
echo "Known issue on macOS 26 (Tahoe): the app may stick on 'select your device'"
echo "even after opening the HID interface. See README and issue #21."
